  ...
  Btn_Home: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      granted: function granted() {
        ...
        var self = this;
        if (isiOS) if (window.DeviceOrientationEvent) {
          console.log("true");
          DeviceMotionEvent.requestPermission().then(function(state) {
            "granted" === state ? window.addEventListener("devicemotion", function() {
        ...
        } else console.log("\u4e0d\u652f\u6301\u9640\u87ba\u4eea"); else if (window.DeviceOrientationEvent) {
          console.log("true");
          window.addEventListener("deviceorientation", function(res) {
            self.spinLabel.string = "\u65cb\u8f6c\u89d2\u5ea6\uff1a" + Math.round(1e3 * Math.abs(res.gamma)) / 1e3;
            console.log("z: " + res.gamma);
          }, true);
        } else console.log("\u4e0d\u652f\u6301\u9640\u87ba\u4eea");
      },
      onClickButton: function onClickButton(sender, str) {
        switch (str) {
         case "start":
