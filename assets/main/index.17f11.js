  ...
  GameManager: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      GetNewWord: function GetNewWord() {
        ...
        this.lastNum == num && (num = Math.floor(Math.random() * this.wordClip.length));
        this.lastNum = num;
      ...
      granted: function granted() {
        ...
        } else window.DeviceOrientationEvent ? DeviceMotionEvent.requestPermission().then(function(state) {
